...
The first build uses polished sample case studies and profile copy so the
experience feels complete. Replace the project names, outcomes, biography,
social links, and email address with final content before sharing widely.

## Tech

- Next.js + TypeScript
- CSS Modules / global CSS design system
- Lucide icons
